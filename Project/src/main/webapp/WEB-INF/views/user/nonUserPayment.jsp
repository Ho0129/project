			...
			if(paymentResult == 'success') {
				...
				$.getJSON(
						...
						function(data) {
							...
							$(data).each(function() {
								console.log(this);
								var timestamp = this.paymentDateCreated;
								var date = new Date(timestamp);
								const TIME_ZONE = 3240 * 10000;
								const date1 = new Date(date);
								const date2 = new Date(+date + TIME_ZONE).toISOString().replace('T', ' ').replace(/\..*/, '');
								...
								list += '<div class = "a">' 
									...
									+ '<tbody id="tbody">'
									+ '<tr>'
									+ '<td><img src="http://localhost:8080/musinsa/product/display?fileName=/' 
									+ this.productVO.productImg +'" width="125px" height="150px"></td>'
