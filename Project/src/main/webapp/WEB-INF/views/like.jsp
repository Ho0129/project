...
<body>
	...
	<c:forEach var="vo" items="${list}">
		<li style="margin-left: 20px;" >
			<a href="http://localhost:8080/musinsa/detail?productNumber=${vo.productVO.productNumber}">
			<img src="http://localhost:8080/musinsa/product/display?fileName=/${vo.productVO.productImg}" width="125px" height="150px"></a>
