...
public class ProductController {
	...
	public String regiterPOST(MultipartFile[] files, HttpServletRequest request, ProductVO vo,
		...
		String productMainCategory = request.getParameter("productMainCategory");
		vo.setProductMainCategory(productMainCategory);
		
		String productMiddleCategory = request.getParameter("productMiddleCategory");
		vo.setProductMiddleCategory(productMiddleCategory);
		
		String productBrand = request.getParameter("productBrand");
		vo.setProductBrand(productBrand);
