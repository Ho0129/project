...
public class ProductDAOImple implements ProductDAO {
	...
	public List<ProductVO> selectByProductName(String productName) {
		...
		// List<ProductVO> list =  sqlSession.selectList(NAMESPACE + ".select_by_product_name", "%" + "상" + "%");
		// logger.info(list.toString());
		return sqlSession.selectList(NAMESPACE + ".select_by_product_name", "%" + productName + "%");
	}

	@Override
	public List<ProductVO> selectByMiddleCategory(String productMiddleCategory) {
		logger.info("DAOImple.selectByMiddleCategory() 호출" + productMiddleCategory);
		return sqlSession.selectList(NAMESPACE + ".select_by_middle_category", productMiddleCategory);
	}
