...
public class ProductServiceImple implements ProductService{
	...
	@Override
	public List<ProductVO> readByProductName(String productName) {
		logger.info("productName = " + productName);
		return dao.selectByProductName(productName);
	}

	@Override
	public List<ProductVO> readByMiddleCategory(String productMiddleCategory) {
		logger.info("middleCate = " + productMiddleCategory);
		return dao.selectByMiddleCategory(productMiddleCategory);
	}
